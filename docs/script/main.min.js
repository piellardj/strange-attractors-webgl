...
var DeJongAttractor = (function () {
    function DeJongAttractor() {
        var _this = this;
        var fillData = new Float32Array(2);
        this._pointsVBO = new vbo_1.default(gl_canvas_1.gl, fillData, 2, gl_canvas_1.gl.FLOAT, false);
        this._shader = null;
    ...
    DeJongAttractor.prototype.drawXPoints = function (nbPoints) {
        ...
        if (shader) {
            ...
            var q = 1 - 254 / 255 * parameters_1.default.quality;
    ...
    DeJongAttractor.prototype.computeXPoints = function (nbPoints) {
        ...
        var a = parameters_1.default.a;
        var b = parameters_1.default.b;
        var c = parameters_1.default.c;
        var d = parameters_1.default.d;
        this._minX = 0;
        this._maxX = 0;
        this._minY = 0;
        this._maxY = 0;
...
function main() {
    ...
    parameters_1.default.clearObservers.push(function () { return needToAdjustCanvas = true; });
    var attractor = new de_jong_1.default();
    var totalPoints;
    ...
    function mainLoop() {
        ...
        if (parameters_1.default.autorun && !drawnOnce) {
