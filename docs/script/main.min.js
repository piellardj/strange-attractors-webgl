...
var parameters_1 = __webpack_require__(/*! ../parameters */ "./src/ts/parameters.ts");
var attractor_1 = __importDefault(__webpack_require__(/*! ./attractor */ "./src/ts/attractors/attractor.ts"));
var CliffordAttractor = (function (_super) {
    __extends(CliffordAttractor, _super);
    function CliffordAttractor() {
        return _super.call(this) || this;
    }
    CliffordAttractor.prototype.toggleParametersVisibility = function () {
        Controls.setVisibility(parameters_1.ControlsID.A, true);
        Controls.setVisibility(parameters_1.ControlsID.B, true);
        Controls.setVisibility(parameters_1.ControlsID.C, true);
        Controls.setVisibility(parameters_1.ControlsID.D, true);
    };
    CliffordAttractor.prototype.computeXPoints = function (nbPoints) {
        var data = new Float32Array(2 * nbPoints);
        var a = parameters_1.Parameters.a;
        var b = parameters_1.Parameters.b;
...
exports.default = CliffordAttractor;
...
/***/ "./src/ts/attractors/fractal-dream.ts":
/*!********************************************!*\
  !*** ./src/ts/attractors/fractal-dream.ts ***!
  \********************************************/
/*! no static exports found */
...
var parameters_1 = __webpack_require__(/*! ../parameters */ "./src/ts/parameters.ts");
var attractor_1 = __importDefault(__webpack_require__(/*! ./attractor */ "./src/ts/attractors/attractor.ts"));
var FractalDreamAttractor = (function (_super) {
    __extends(FractalDreamAttractor, _super);
    function FractalDreamAttractor() {
        return _super.call(this) || this;
    }
    FractalDreamAttractor.prototype.toggleParametersVisibility = function () {
        Controls.setVisibility(parameters_1.ControlsID.A, true);
        Controls.setVisibility(parameters_1.ControlsID.B, true);
        Controls.setVisibility(parameters_1.ControlsID.C, true);
        Controls.setVisibility(parameters_1.ControlsID.D, true);
    };
    FractalDreamAttractor.prototype.computeXPoints = function (nbPoints) {
        var data = new Float32Array(2 * nbPoints);
        var a = parameters_1.Parameters.a;
        var b = parameters_1.Parameters.b;
        var c = parameters_1.Parameters.c;
    ...
    return FractalDreamAttractor;
}(attractor_1.default));
exports.default = FractalDreamAttractor;
...
var clifford_1 = __importDefault(__webpack_require__(/*! ./attractors/clifford */ "./src/ts/attractors/clifford.ts"));
var de_jong_1 = __importDefault(__webpack_require__(/*! ./attractors/de-jong */ "./src/ts/attractors/de-jong.ts"));
var fractal_dream_1 = __importDefault(__webpack_require__(/*! ./attractors/fractal-dream */ "./src/ts/attractors/fractal-dream.ts"));
var parameters_1 = __webpack_require__(/*! ./parameters */ "./src/ts/parameters.ts");
function main() {
    initGL();
    ...
    attractors[parameters_1.attractorNames.Clifford] = new clifford_1.default();
    attractors[parameters_1.attractorNames.DeJong] = new de_jong_1.default();
    attractors[parameters_1.attractorNames.FractalDream] = new fractal_dream_1.default();
    var totalPoints;
